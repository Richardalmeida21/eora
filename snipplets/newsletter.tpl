...
{% if settings.news_show %}
    <div id="newsletter-footer" class="js-newsletter newsletter ">
        <div class="d-flex flex-column w-100" style="max-width:600px;">
            ...
            {% endif %}
            <form class="js-newsletter-form w-100" method="post" action="/winnie-pooh" onsubmit="this.setAttribute('action', window.location.pathname + window.location.search + '#newsletter-footer');" data-store="newsletter-form">
                <div class="newsletter-form input-append d-flex flex-column w-100" style="gap:16px;">
                        <div class="input-group w-100">
                            {% embed "snipplets/forms/form-input.tpl" with{
                                input_for: 'newsletter-name',
                                type_text: true,
                                input_name: 'name',
                                input_id: 'newsletter-name',
                                input_placeholder: 'Nome:',
                                input_group_custom_class: 'mb-0',
                                input_custom_class: 'form-control-line',
                                input_aria_label: 'Nome para newsletter',
                                input_required: true,
