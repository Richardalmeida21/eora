...
{% if num_messages %}
	{% if not section_animated %}
		<div class="container-fluid text-center js-swiper-messages">
	{% endif %}
	{% for i in 1..section_repeat_number %}
		...
		{% else %}
			<div class="swiper" style="max-width: 100%;overflow: hidden">
				<div class="home-text-container swiper-wrapper">
		{% endif %}
			{% if section_animated %}
				{% if num_messages == 1 %}
				...
				{% for section_id in [section_id ~ '_01', section_id ~ '_02', section_id ~ '_03'] %}
					...
					{% if section_message %}
						<div class="swiper-slide">
							<span class="home-text {{ section_text_classes }}">
								{% if section_link %}
									<a href="{{ section_link }}">
								{% endif %}
								{{ section_message }}
