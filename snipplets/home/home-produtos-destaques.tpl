...
{% if has_featured or has_new or has_sale %}
	<section class="section-home section-featured-home {{ section_classes }}" data-store="home-products-{{ data_store_name }}">
		{% if has_featured %}
			{% include 'snipplets/home/home-produtos-destaques-grid.tpl' with {'featured_products': true} %}
		{% endif %}
		{% if has_new %}
			{% include 'snipplets/home/home-produtos-destaques-grid.tpl' with {'new_products': true} %}
		{% endif %}
		{% if has_sale %}
			{% include 'snipplets/home/home-produtos-destaques-grid.tpl' with {'sale_products': true} %}
		{% endif %}
	</section>
{% endif %}
