{# Banner inferior 3 #}
{% if settings.behind_lens_page_banner_bottom_terceiro and settings.behind_lens_page_banner_bottom_img_terceiro %}
    <section class="section-home banner-inferior-section">
        <div class="container-fluid">
            {% for banner in settings.behind_lens_page_banner_bottom_img_terceiro %}
