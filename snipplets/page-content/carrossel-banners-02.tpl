{% set sliders_imgs_active = attribute(settings,"#{settings_name}_sliders_imgs_active_segundo") %}
{% set sliders_imgs = attribute(settings,"#{settings_name}_sliders_imgs_segundo") %}
{% set sliders_imgs_format = attribute(settings,"#{settings_name}_sliders_imgs_format_segundo") %}
		...
		<div class="container-fluid">
			{% if section_slider %}
				<div class="infinite-carousel-container">
					<div class="infinite-carousel-track" id="carousel-track-02">
