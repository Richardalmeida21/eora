...
- Os includes de CSS/JS em `snipplets/bolsas-eora/index.tpl` usam a versao `?v=20260918-4`. Ao atualizar esses assets, incrementar a versao e publicar o TPL junto: em 18/09, o CDN ainda entregava o script anterior sem a consulta inicial, enquanto uma URL versionada entregava a versao nova. Atualizar apenas o JS nao invalidava aquela resposta em cache.
