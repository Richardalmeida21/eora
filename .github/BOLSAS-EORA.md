...
- O JS principal e o CSS usam `?v=20260921-15`, e o script de opções usa `?v=20260918-5`. Publicar juntos configurações, `banners.tpl`, `product-card.tpl`, CSS, scripts e `index.tpl` para atualizar também as URLs do cache.
